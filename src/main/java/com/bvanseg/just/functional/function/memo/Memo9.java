...
public class Memo9<A1, A2, A3, A4, A5, A6, A7, A8, A9, R> implements Function9<A1, A2, A3, A4, A5, A6, A7, A8, A9, R> {
    ...
    private final Function9<A1, A2, A3, A4, A5, A6, A7, A8, A9, R> fn;
    ...
    public Memo9(Function9<A1, A2, A3, A4, A5, A6, A7, A8, A9, R> fn) {
        this(
            fn,
    ...
    public Memo9(
        Function9<A1, A2, A3, A4, A5, A6, A7, A8, A9, R> fn,
    ...
    public R apply(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9) {
        if (
            eq1.test(a1Ref, a1) && eq2.test(a2Ref, a2) && eq3.test(a3Ref, a3) && eq4.test(a4Ref, a4) && eq5.test(
                a5Ref,
                a5
            ) && eq6.test(a6Ref, a6) && eq7.test(a7Ref, a7) && eq8.test(a8Ref, a8) && eq9.test(a9Ref, a9)
        ) {
            return cachedResult;
        }

        this.cachedResult = fn.apply(a1, a2, a3, a4, a5, a6, a7, a8, a9);
        this.a1Ref = a1;
        this.a2Ref = a2;
        this.a3Ref = a3;
        this.a4Ref = a4;
