...
public interface Function12<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, R> {
    ...
    static <A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, R> Function12<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, R> fromCurried(
        Function<A1, Function<A2, Function<A3, Function<A4, Function<A5, Function<A6, Function<A7, Function<A8, Function<A9, Function<A10, Function<A11, Function<A12, R>>>>>>>>>>>> curried
    ) {
        return (a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12) -> curried.apply(a1)
            .apply(a2)
            .apply(a3)
            .apply(a4)
            .apply(a5)
