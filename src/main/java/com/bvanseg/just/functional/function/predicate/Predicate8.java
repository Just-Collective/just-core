...
public interface Predicate8<A1, A2, A3, A4, A5, A6, A7, A8> {
    ...
    default Function8<A1, A2, A3, A4, A5, A6, A7, A8, Boolean> toFunction() {
        return this::test;
    }

    default Function<A1, Function<A2, Function<A3, Function<A4, Function<A5, Function<A6, Function<A7, Function<A8, Boolean>>>>>>>> curried() {
        return a1 -> a2 -> a3 -> a4 -> a5 -> a6 -> a7 -> a8 -> this.test(a1, a2, a3, a4, a5, a6, a7, a8);
    }
