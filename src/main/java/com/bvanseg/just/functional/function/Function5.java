...
public interface Function5<A1, A2, A3, A4, A5, R> {
    ...
    static <A1, A2, A3, A4, A5, R> Function5<A1, A2, A3, A4, A5, R> fromCurried(
        Function<A1, Function<A2, Function<A3, Function<A4, Function<A5, R>>>>> curried
    ) {
        return (a1, a2, a3, a4, a5) -> curried.apply(a1).apply(a2).apply(a3).apply(a4).apply(a5);
    }
}
