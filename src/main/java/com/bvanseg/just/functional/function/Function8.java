...
public interface Function8<A1, A2, A3, A4, A5, A6, A7, A8, R> {
    ...
    static <A1, A2, A3, A4, A5, A6, A7, A8, R> Function8<A1, A2, A3, A4, A5, A6, A7, A8, R> fromCurried(
        Function<A1, Function<A2, Function<A3, Function<A4, Function<A5, Function<A6, Function<A7, Function<A8, R>>>>>>>> curried
    ) {
        return (a1, a2, a3, a4, a5, a6, a7, a8) -> curried.apply(a1)
            .apply(a2)
            .apply(a3)
            .apply(a4)
            .apply(a5)
