...
public class Memo5<A1, A2, A3, A4, A5, R> implements Function5<A1, A2, A3, A4, A5, R> {
    ...
    private final Function5<A1, A2, A3, A4, A5, R> fn;
    ...
    public Memo5(Function5<A1, A2, A3, A4, A5, R> fn) {
        this(
            fn,
    ...
    public R apply(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5) {
        ...
        this.cachedResult = fn.apply(a1, a2, a3, a4, a5);
        this.a1Ref = a1;
        this.a2Ref = a2;
        this.a3Ref = a3;
        this.a4Ref = a4;
