...
public class Memo10<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R> implements Function10<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R> {
    ...
    private final Function10<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R> fn;
    ...
    public Memo10(Function10<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R> fn) {
        this(
            fn,
    ...
    public Memo10(
        Function10<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R> fn,
    ...
    @Override
    public R apply(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9, A10 a10) {
        if (
        ...
        this.cachedResult = fn.apply(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10);
        this.a1Ref = a1;
        this.a2Ref = a2;
        this.a3Ref = a3;
        this.a4Ref = a4;
